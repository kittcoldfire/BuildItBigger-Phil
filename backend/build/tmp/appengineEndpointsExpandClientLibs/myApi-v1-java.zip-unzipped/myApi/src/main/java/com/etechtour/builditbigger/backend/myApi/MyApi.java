...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://black-function-112915.appspot.com/_ah/api/";
  ...
  public class SayHi extends MyApiRequest<com.etechtour.builditbigger.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.etechtour.builditbigger.backend.myApi.model.MyBean.class);
  ...
  public class TellJoke extends MyApiRequest<com.etechtour.builditbigger.backend.myApi.model.MyBean> {
